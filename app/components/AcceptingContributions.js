    ...
    >
      ...
      >
        ...
        <Text
          ...
          fontWeight="400"
        >
          The Made in Nigeria project is built on the back of builders that
          create and discover these amazing projects. Learn how to submit (your)
          projects here.
        </Text>
        <Box marginTop={3}>
          <SubmitProject
            text="Submit Project"
            link="https://github.com/acekyd/made-in-nigeria/blob/master/CONTRIBUTING.MD"
          />
        </Box>
      </Box>
    </Box>
