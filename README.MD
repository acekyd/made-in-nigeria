...
- [Docker for Django](https://github.com/homescriptone/docker-for-django) - A template to easily build a Django project in a Docker container.  **By [@homescriptone](https://homescriptone.com)**
