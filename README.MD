...
- [dotenv.net](https://github.com/bolorundurowb/dotenv.net) - a group of projects written in C# that aim to make the process of reading `.env` files as simple and pain-free as possible in the dotnet ecosystem. **By [@bolorundurowb](https://github.com/bolorundurowb)**
...
- [geo-info-service](https://github.com/bolorundurowb/geo-info-service) - A service to provide geographic information about continents, countries, states/provinces, international dialling codes and currencies. **By [@bolorundurowb](https://github.com/bolorundurowb)**
...
- [Git Aliases For Windows](https://github.com/bolorundurowb/git-aliases-for-windows) - A batch script to add in git aliases to the windows console. **By [@bolorundurowb](https://github.com/bolorundurowb)**
...
- [logly](https://github.com/bolorundurowb/logly) -  a library written for ASP.NET Core similar in functionality to morgan for NodeJS. Its purpose to make request and response logging more aesthetically pleasing. **By [@bolorundurowb](https://github.com/bolorundurowb)**
...
- [moment.net](https://github.com/bolorundurowb/moment.net) - A dotnet port of as many bits of functionality from moment.js as is necessary written in C#. **By [@bolorundurowb](https://github.com/bolorundurowb) and [@yemikudaisi](https://github.com/yemikudaisi)**
...
- [no-comment](https://github.com/bolorundurowb/no-comment) - A browser plugin that can show or hide comments from social platforms such as YouTube and Facebook as we deserve to view content and form our opinions without bias. **By [@bolorundurowb](https://github.com/bolorundurowb)**
...
- [Open Exam Suite](https://github.com/bolorundurowb/Open-Exam-Suite) - A set of UI tools and libraries that allow for the creation and administration of computer-based examinations with support for multiple choice questions, corrections and result summation. **By [@bolorundurowb](https://github.com/bolorundurowb)**
...
- [shortid](https://github.com/bolorundurowb/shortid) - A C# library to generate random URL-safe short IDs. **By [@bolorundurowb](https://github.com/bolorundurowb)**
