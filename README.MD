...
- [moment.net](https://github.com/bolorundurowb/moment.net) - A dotnet port of as many bits of functionality from moment.js as is necessary written in C#. **By [@bolorundurowb](https://github.com/bolorundurowb)**
