...
- [CodeOps Studio](https://github.com/euptron/CodeOps-Studio) - A mobile-based integrated development environment (IDE) and Code Editor for Android devices. **By [@euptron](https://github.com/euptron)**
