...
- [another](https://github.com/Zfinix/another) - A desktop app for mirroring and controlling Android devices over USB. Built with Tauri, React, and Rust. **By [@chiziaruhoma](https://chizi.app)**
- [Appshots](https://github.com/oyeolamilekan/appshots) - A simple app that enables developers to generate app store screenshots **By [@magicnull](https://twitter.com/magicnull)**
...
- [Clipio](https://github.com/JesseJohn7/Clipio) - A fast video downloader supporting TikTok, Instagram, Facebook, and X (Twitter). **By [@JesseJohn7](https://twitter.com/Jesse_can_code)**
...
- [Corelens](https://github.com/Varsilias/corelens) - Opinionated, high-performance observability SDK for Node.js application that provides logs, metrics, and traces with minimal setup and first class support for OpenTelemetry API specification **By [@varsilias](https://x.com/varsilias)**
...
- [DB Mover](https://github.com/JC-Coder/db-mover) - An open-source tool for simplifying database migrations across providers without manual dump handling or connection string wrestling. **By [@jc_coder1](https://twitter.com/jc_coder1)**
...
- [Marble](https://github.com/usemarble/marble) - A Simple headless CMS for publishing articles. **By [@taqh](https://twitter.com/retaqib)**
...
- [OmniCoreAgent](https://github.com/omnirexflora-labs/omnicoreagent) - Open production agent harness for application builders, providing a Python runtime for model loops, tools, MCP integration, memory, workspace files, guardrails, subagents, background tasks, and serving APIs. **By [@abiorhmangana](https://x.com/abiorhmangana)**
...
- [Tablesmit](https://github.com/Olayiwola72/tablesmit) - A minimalist, open source table builder for analytical writing. Build clean structured tables with full control over headers, column types, and formatting. Supports drag-to-resize, merge cells, smart clipboard paste from Excel, and export to PDF, Excel, CSV, and PNG. No signup required. **By [@OlayiwolaAkinn1](https://x.com/OlayiwolaAkinn1)**
